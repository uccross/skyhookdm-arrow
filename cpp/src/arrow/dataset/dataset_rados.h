...
class ARROW_DS_EXPORT RadosFragment : public Fragment {
 public:
  ...
  /// \param[in] object a RadosObject instance containing information about the object to write.
  static Status WriteFragment(RecordBatchVector &batches, std::shared_ptr<RadosOptions> rados_options, std::shared_ptr<RadosObject> object);
